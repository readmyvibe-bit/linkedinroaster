...
const roastPlans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: '10 Interview Preps (15 questions + quiz)', included: true },
      { text: 'AI Enhance Editor', included: true },
      { text: 'Shareable profile card', included: true },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: '25 Resumes + 25 Cover Letters + 25 Interview Preps', included: true },
...
const buildPlans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: '10 ATS Resumes (18 standard templates)', included: true },
      { text: '10 Cover Letters', included: true },
      { text: '10 Interview Preps', included: true },
