...
export const metadata: Metadata = {
  ...
  description: 'Refund policy for Profile Roaster LinkedIn analysis service.',
};
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: 'var(--li-text-primary)' }}>
          ...
          <section>
            ...
            <p>
              ...
              conditions under which we offer refunds for our paid services (Standard Plan at &#8377;299 and Pro Plan at &#8377;599).
            </p>
            <p className="mt-2">
              Because our Service involves AI processing that consumes computational resources upon order fulfillment,
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Our AI pipeline fails to process your profile and does not deliver results</li>
              <li>The order gets stuck in processing for more than 10 minutes without completion</li>
              <li>A system error prevents delivery of your roast, rewrite, or scores</li>
              <li>Payment was captured but the order was not created in our system</li>
            </ul>
            <p className="mt-2">
              In these cases, our system automatically detects the failure during the quality check stage and initiates a refund
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>The roast contains offensive, discriminatory, or personally attacking content (beyond the intended humor)</li>
              ...
              <li>The scores or analysis are clearly nonsensical (e.g., a well-written profile scoring 5/100)</li>
            </ul>
            <p className="mt-2">
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Your order ID (found in your results URL)</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li><strong>Subjective dissatisfaction:</strong> You disagree with the roast humor, tone, or severity (the roast is intentionally brutal by design)</li>
              ...
              <li><strong>Insufficient input:</strong> You pasted minimal profile data (e.g., only a headline) and received limited results as a consequence</li>
              <li><strong>Duplicate orders:</strong> You placed multiple orders for the same profile (contact us to resolve duplicates before requesting a refund)</li>
              <li><strong>Change of mind:</strong> You no longer want the Service after results have been delivered</li>
              <li><strong>Third-party issues:</strong> Your LinkedIn profile was updated after submitting and the results no longer match your current profile</li>
              <li><strong>Upgrade dissatisfaction:</strong> You upgraded from Standard to Pro and are unsatisfied with the additional Pro features only (the Standard results were already delivered and consumed)</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Refund amount: Full order amount (&#8377;299 or &#8377;599)</li>
            ...
            <p>
              All refunds are processed through Razorpay and returned to the original payment method used during checkout.
              This includes:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li><strong>Pro upgrade issues:</strong> If the Standard results were satisfactory but Pro features had issues, we may refund only the upgrade amount (&#8377;300)</li>
              <li><strong>Reprocessing:</strong> In lieu of a refund, we may offer to reprocess your profile through the pipeline at no additional cost</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>If processing has not started (status is still &ldquo;queued&rdquo;), we will issue a full refund</li>
              <li>If processing has already begun (parsing, analyzing, roasting, or rewriting), cancellation is not possible as AI resources have already been consumed</li>
            </ul>
            <p className="mt-2">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>As a last resort, disputes are subject to the jurisdiction of courts in New Delhi, India</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>Using the results and then requesting a refund</li>
