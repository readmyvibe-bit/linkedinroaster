...
export default function ResumePreviewPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-canvas)' }}>
      ...
      {/* ═══ MOBILE STICKY ═══ */}
      <div className="md:hidden" style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: 'var(--bg-surface)', borderTop: '1px solid var(--border-default)', padding: '10px 16px', zIndex: 50, display: 'flex', gap: 8, boxShadow: 'var(--shadow-md)' }}>
