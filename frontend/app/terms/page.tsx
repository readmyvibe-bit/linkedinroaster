        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: 'var(--li-text-primary)' }}>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li><strong>Standard Plan:</strong> &#8377;299 (INR) &mdash; complete roast + rewrite, ATS resume builder (18 templates), 1 cover letter, free rescore</li>
              <li><strong>Pro Plan:</strong> &#8377;799 (INR) &mdash; everything in Standard + 5 headline variations, all 28 premium templates, 3 cover letters, advanced ATS keyword matching, priority processing</li>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li><strong>Plus:</strong> &#8377;399 (INR) &mdash; everything in Starter + ATS resume builder (18 templates), 1 cover letter, job description targeting</li>
              <li><strong>Pro:</strong> &#8377;699 (INR) &mdash; everything in Plus + 3 cover letters, all 28 premium templates, priority processing</li>
            </ul>
