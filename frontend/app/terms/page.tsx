        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: 'var(--li-text-primary)' }}>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li><strong>Pro Plan:</strong> &#8377;799 (INR) &mdash; everything in Standard + 5 headline variations, ATS keywords, 3 resumes, all 20 templates, cover letters</li>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li><strong>Pro:</strong> &#8377;699 (INR) &mdash; everything in Plus + 3 resumes, 3 cover letters, all 20 templates</li>
            </ul>
